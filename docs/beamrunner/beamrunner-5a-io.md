...
To use Publish and Subscribe transforms in your Beam application, ensure to include the Streams Runner SDK jar (`com.ibm.streams.beam.sdk.jar`) inside `$STREAMS_BEAM_TOOLKIT/lib`. 
